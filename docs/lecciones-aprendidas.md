...
6. **Todo enlace visible debe tener una ruta real antes de mostrarse al usuario:** `Mi Perfil` y `Preferencias` existian en el menu, pero no como paginas. Un dropdown pequeño tambien es superficie de producto; si apunta a 404, rompe confianza aunque el modulo principal funcione.
